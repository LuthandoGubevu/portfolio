  ...
  return (
    <section id="projects" className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <p className="max-w-2xl mx-auto text-center text-foreground/70 mb-12">These projects showcase my full development process, from initial concept and UI/UX design in Figma to coding, deployment, and managing iterations with GitHub.</p>
